...
p_pc = (1-h2s_comp-co2_comp-n2_comp-h2o_comp)*p_pch + (1306*h2s_comp) + (1071*co2_comp) +/
            (493.1*n2_comp) + (3200.1*h2o_comp)
 t_pc = (1-h2s_comp-co2_comp-n2_comp-h2o_comp)*p_pch + (672.35*h2s_comp) + (547.58*co2_comp) +/
            (227.16*n2_comp) + (1164.*h2o_comp)
...
print('The hydrocarbon pseudo-critical temprature is {0:.1f} psia'.format(t_pc)) 
print('The hydrocarbon pseudo-critical pressure is {0:.1f} psia'.format(p_pc)
